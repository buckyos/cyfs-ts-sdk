...
export class Interface {
    ...
    encodeFilterTopics(eventFragment: EventFragment, values: ReadonlyArray<any>): (string | string[]|null)[] {
        if (typeof(eventFragment) === "string") {
            eventFragment = this.getEvent(eventFragment);
        }
    ...
    encodeEventLog(eventFragment: EventFragment, values: ReadonlyArray<any>): { data: string, topics: string[] } {
        if (typeof(eventFragment) === "string") {
            eventFragment = this.getEvent(eventFragment);
        }

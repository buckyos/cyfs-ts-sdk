...
export class ProofOfSNService implements RawEncode {
    constructor(
        ...
        public ping_count: bigint,
        public ping_resp_count: bigint,
        public called_count: bigint,
        public call_peer_count: bigint,
        public connect_peer_count: bigint,
        public call_delay: bigint,
    ){
        // ignore
    }

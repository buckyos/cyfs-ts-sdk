...
export class TrafficContract implements RawEncode {
    constructor(
        ...
        public max_up_bytes: Option<bigint>,
        public max_up_speed: Option<number>,
        public min_up_speed: Option<number>,
        public max_down_bytes: Option<bigint>,
    ...
    raw_measure(ctx?:any): BuckyResult<number>{
        ...
        size += OptionEncoder.from(this.max_up_bytes, (v:bigint)=>new BuckyNumber('u64', v)).raw_measure().unwrap();
        ...
        size += OptionEncoder.from(this.max_down_bytes, (v:bigint)=>new BuckyNumber('u64', v)).raw_measure().unwrap();
    ...
    raw_encode(buf: Uint8Array, ctx?:any): BuckyResult<Uint8Array>{
        ...
        buf = OptionEncoder.from(this.max_up_bytes, (v:bigint)=>new BuckyNumber('u64', v)).raw_encode(buf).unwrap();
        ...
        buf = OptionEncoder.from(this.max_down_bytes, (v:bigint)=>new BuckyNumber('u64', v)).raw_encode(buf).unwrap();

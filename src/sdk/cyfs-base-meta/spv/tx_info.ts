...
import { TxMetaData } from './tx_meta_data';


export class TxInfo {
    constructor(
        public status: number,
        public tx: TxMetaData,
        public block_number: Option<string>,
        public block_hash: Option<string>,
        public block_create_time: Option<string>,
    ){
        // ignore
    }

...
export class Area implements RawEncode {
    ...
    get_area_info(locale?: string): { country_name: string, state_name: string, city_name: string } | null {
        return get_area_info(this.m_country.toString(10), this.m_city.toString(10), locale);
    }
